/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9b14a9cb67d5e4da950e1a7936b6ef75)
...
interface __BaseEnv_Env {
	...
	ACQUISITION_MODE: "fixture" | "disabled";
	ACCESS_TEAM_DOMAIN: "replace-preview.cloudflareaccess.com" | "replace-production.cloudflareaccess.com" | "local.invalid";
	ACCESS_AUD: "replace-preview-access-audience" | "replace-production-access-audience" | "local-unused";
	ACCESS_OPERATOR_SUBJECT: "replace-operator-subject" | "local-operator";
	TRUSTED_ORIGIN: "https://replace-preview.invalid" | "https://replace-production.invalid" | "http://localhost:3000";
	CLOUDFLARE_OBSERVABILITY_URL: "https://dash.cloudflare.com/";
	OPERATOR_EMAIL: "replace-operator@example.com" | "operator@local.invalid";
	ALERT_FROM_EMAIL: "replace-alerts@example.com" | "alerts@local.invalid";
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		ACCESS_TEAM_DOMAIN: "replace-preview.cloudflareaccess.com";
		ACCESS_AUD: "replace-preview-access-audience";
		ACCESS_OPERATOR_SUBJECT: "replace-operator-subject";
		TRUSTED_ORIGIN: "https://replace-preview.invalid";
		CLOUDFLARE_OBSERVABILITY_URL: "https://dash.cloudflare.com/";
		OPERATOR_EMAIL: "replace-operator@example.com";
		ALERT_FROM_EMAIL: "replace-alerts@example.com";
	}
	interface ProductionEnv {
		...
		ACCESS_TEAM_DOMAIN: "replace-production.cloudflareaccess.com";
		ACCESS_AUD: "replace-production-access-audience";
		ACCESS_OPERATOR_SUBJECT: "replace-operator-subject";
		TRUSTED_ORIGIN: "https://replace-production.invalid";
		CLOUDFLARE_OBSERVABILITY_URL: "https://dash.cloudflare.com/";
		OPERATOR_EMAIL: "replace-operator@example.com";
		ALERT_FROM_EMAIL: "replace-alerts@example.com";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ACQUISITION_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "ACCESS_OPERATOR_SUBJECT" | "TRUSTED_ORIGIN" | "CLOUDFLARE_OBSERVABILITY_URL" | "OPERATOR_EMAIL" | "ALERT_FROM_EMAIL">> {}
}
